...
public class ReservationController {
    ...
    @GetMapping("/api/reservation/mine")
    @ApiOperation(value="내 예약 조회" , notes = "내 예약 정보를 모두 조회할 수 있다.")
    public ResponseEntity<ReservationInfos> getReservationFromMemberId(@RequestBody @Valid UserId userId) {
      ReservationInfos infos = reservationService.getAllReservationFromMemberId(userId.getUserId());
